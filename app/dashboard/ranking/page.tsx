...
import { Trophy, Medal, Star, AlertCircle, RefreshCw, X, Flashlight } from 'lucide-react';
          ...
          <div className="grid gap-4">
            ...
            <div className="space-y-3 mt-12">
              {(hasPoints ? ranking.slice(3) : ranking).map((user, idx) => {
                const absoluteRankIndex = hasPoints ? idx + 3 : idx;
                return (
                  <motion.div
                    key={user.id}
              ...
              <div className="flex flex-col sm:flex-row items-center gap-6 mb-8 mt-2">
                ...
                <div className="text-center sm:text-left">
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2 justify-center sm:justify-start">
                    <h3 className="text-2xl font-black uppercase tracking-tight text-white flex items-center gap-1.5">
                      {ranking.findIndex(u => u.id === selectedUser.id) === 0 && <span>🥇</span>}
                      {ranking.findIndex(u => u.id === selectedUser.id) === 1 && <span>🥈</span>}
